...
\section{Experience}
  ...
  \resumeSubheadingexp{Unify Technologies Inc. $|$ Meta Reality Labs (Client)}{Redmond, WA}{Robotics Engineer, Contract}{March 2025 - Present}
    ...
    \resumeItem{Designed and implemented test protocols for sensing and actuation technologies including voice coils, piezoelectric devices, and linear resonant actuators (LRAs), supporting hardware characterization for wearable haptic projects.}
    \resumeItem{Applied laser vibrometry for precise actuator displacement and vibration measurements, calibrating test equipment and validating device performance against design specifications.}
    ...
    \vspace{10pt}
    \resumeSubheadingexp{ONY Biotech - Human in Loops Systems Lab}{Buffalo, NY}{Graduate Research Assistant}{Aug 2023 - May 2024}
...
\section{Volunteering}
  \resumeSectionStart
    \resumeSubheadingexp{University at Buffalo - Human in the Loop Systems Lab}{Buffalo, NY}{Research Scholar}{Aug 2024 - Jan 2025}
      \resumeItem{Continued master's project research as a full-time Volunteer Research Scholar in the Human in the Loop Systems Laboratory, focused on soft object manipulation using robotic systems.}
      \resumeItem{Ran simulation and experimental studies on robotic manipulation techniques for surgical and biological tissue scenarios, working toward improved precision in deformable object handling.}
      \resumeItem{Designed and tested new manipulation strategies in simulation, building on an existing functional prototype to expand the range of approaches for sensitive, contact-rich tasks.}
      \resumeItem{Applied graduate coursework in Robotics Algorithms, Machine Learning, Kinematics and Dynamics, Computer Vision, and Human-Robot Interaction to shape experimental design and research methodology.}

    \vspace{10pt}
    \resumeSubheadingexp{Bright Mind Enrichment and Schooling}{San Francisco, CA (Remote)}{Data Analyst}{Jan 2025 - Mar 2025}
      \resumeItem{Volunteered part-time as a Data Analyst for a 501(c)(3) nonprofit, contributing to data collection, cleaning, and analysis processes that supported organizational decisions.}
      \resumeItem{Performed data manipulation, cleansing, and exploratory and statistical analyses using \textbf{SQL}, \textbf{R}, and \textbf{SAS} to help the team make informed, evidence-based business decisions.}
      \resumeItem{Built and tracked KPI dashboards to measure campaign performance and identify areas for improvement across outreach and fundraising efforts.}
      \resumeItem{Applied coursework in Machine Learning and Probability from an Engineering Science background to strengthen data analysis methods and improve reporting workflows.}
  \resumeSectionEnd
...
\section{Education}
  \resumeSectionStart
    \resumeSubheadingedu
      {Master of Science in Engineering Science (Robotics)}{Buffalo, NY}

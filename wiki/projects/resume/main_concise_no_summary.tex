...
\section{Volunteering}
  \resumeSectionStart
    \resumeSubheadingexp{University at Buffalo - Human in the Loop Systems Lab}{Buffalo, NY}{Research Scholar}{Aug 2024 - Jan 2025}
      \resumeItem{Developed simulation environments for soft object manipulation using robotic systems, extending master's research on deformable tissue manipulation in surgical and biological contexts.}
      \resumeItem{Researched and prototyped robotic manipulation strategies for precision-sensitive dynamic environments, applying coursework in Robotics Algorithms, Computer Vision, and Machine Learning.}

    \vspace{10pt}
    \resumeSubheadingexp{Bright Mind Enrichment and Schooling}{San Francisco, CA (Remote)}{Data Analyst}{Jan 2025 - Mar 2025}
      \resumeItem{Streamlined data collection processes and performed data manipulation, cleansing, and exploratory and statistical analysis to support business decisions using \textbf{SQL}, \textbf{R}, and \textbf{SAS}.}
      \resumeItem{Developed and tracked KPI metrics using a data-driven approach to assess campaign success and optimize future campaign tactics for the nonprofit.}
  \resumeSectionEnd

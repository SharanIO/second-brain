...
\section{Volunteering}
  \resumeSectionStart
    \resumeSubheadingexp{University at Buffalo - Human in the Loop Systems Lab}{Buffalo, NY}{Research Scholar}{Aug 2024 - Jan 2025}
      \resumeItem{Served full-time (40 hrs/week) as a Volunteer Research Scholar in the Human in the Loop Systems Laboratory, directly continuing master's project research on soft object manipulation using robotic systems.}
      \resumeItem{Advanced robotic manipulation techniques through intensive simulation and experimental research, developing innovative strategies for complex manipulation tasks particularly in surgical and biological tissue environments.}
      \resumeItem{Leveraged simulation tools to conceive and validate additional advanced manipulation strategies, building on a functional prototype developed during the master's project to enhance robot precision and adaptability in sensitive, dynamic environments.}
      \resumeItem{Applied graduate coursework in Robotics Algorithms, Machine Learning, Kinematics and Dynamics, Computer Vision, and Human-Robot Interaction to guide research direction, experimental methodology, and safety-critical decision-making.}

    \vspace{10pt}
    \resumeSubheadingexp{Bright Mind Enrichment and Schooling}{San Francisco, CA (Remote)}{Data Analyst}{Jan 2025 - Mar 2025}
      \resumeItem{Volunteered part-time (25 hrs/week) as a Data Analyst, applying engineering and analytical expertise to enhance data-driven decision-making within educational and nonprofit sectors.}
      \resumeItem{Streamlined data collection processes and executed advanced data manipulation, cleansing, and exploratory and statistical analyses to guide strategic business decisions using \textbf{SQL}, \textbf{R}, and \textbf{SAS}.}
      \resumeItem{Developed and monitored key performance indicators (KPIs), leveraging a data-driven approach to assess campaign effectiveness and optimize future campaign tactics in support of the nonprofit mission.}
      \resumeItem{Applied analytical foundations from Engineering Science coursework — including Machine Learning and Probability — to deliver a robust analytical toolkit supporting organizational strategy.}
  \resumeSectionEnd
